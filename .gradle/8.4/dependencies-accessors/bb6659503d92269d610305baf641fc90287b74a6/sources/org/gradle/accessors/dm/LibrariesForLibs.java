...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class KoinLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Returns the group of libraries at koin.core
         */
    ...
    public static class KoinAndroidLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        public KoinAndroidLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for android (org.koin:koin-android)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> asProvider() {
            ...
            /**
             * Creates a dependency provider for v100 (org.koin:koin-android)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getV100() {
                return create("koin.android.v100");
        }

            /**
             * Creates a dependency provider for viewmodel (org.koin:koin-android-viewmodel)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getViewmodel() {
                return create("koin.android.viewmodel");
        }

    }

    public static class KoinAndroidxLibraryAccessors extends SubDependencyFactory {
        private final KoinAndroidxScopeLibraryAccessors laccForKoinAndroidxScopeLibraryAccessors = new KoinAndroidxScopeLibraryAccessors(owner);
        private final KoinAndroidxViewmodelLibraryAccessors laccForKoinAndroidxViewmodelLibraryAccessors = new KoinAndroidxViewmodelLibraryAccessors(owner);

        public KoinAndroidxLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for core (org.koin:koin-androidx-core)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getCore() {
                return create("koin.androidx.core");
        }

        /**
         * Returns the group of libraries at koin.androidx.scope
         */
        public KoinAndroidxScopeLibraryAccessors getScope() {
            return laccForKoinAndroidxScopeLibraryAccessors;
        }

        /**
         * Returns the group of libraries at koin.androidx.viewmodel
         */
        public KoinAndroidxViewmodelLibraryAccessors getViewmodel() {
            return laccForKoinAndroidxViewmodelLibraryAccessors;
        }

    }

    public static class KoinAndroidxScopeLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public KoinAndroidxScopeLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for scope (org.koin:koin-androidx-scope)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> asProvider() {
            ...
            /**
             * Creates a dependency provider for v100 (org.koin:koin-androidx-scope)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getV100() {
                return create("koin.androidx.scope.v100");
        }

    }

    public static class KoinAndroidxViewmodelLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public KoinAndroidxViewmodelLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for viewmodel (org.koin:koin-androidx-viewmodel)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> asProvider() {
            ...
            /**
             * Creates a dependency provider for v100 (org.koin:koin-androidx-viewmodel)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getV100() {
                return create("koin.androidx.viewmodel.v100");
        }
    ...
    public static class KoinCoreLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        public KoinCoreLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for jvm (io.insert-koin:koin-core-jvm)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getJvm() {
                return create("koin.core.jvm");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: coreKtxVersion (1.7.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: koinAndroid (3.2.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: koinAndroidVersion (1.0.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: koinAndroidxScope (1.0.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getKoinAndroidxScope() { return getVersion("koinAndroidxScope"); }

            /**
             * Returns the version associated to this alias: koinAndroidxViewmodel (1.0.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: koinCore (3.1.2)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: koinCoreJvm (2.0.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getKoinCoreJvm() { return getVersion("koinCoreJvm"); }
            ...
            /**
             * Returns the version associated to this alias: kotlinStdlib (1.9.10)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
